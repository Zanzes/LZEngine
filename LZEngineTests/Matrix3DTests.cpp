...
void testRotation()
{
	...
	op = T::rotateOnZ(LZSoft::Math::PI / 2);
	...
	op = T::rotateOnZ(LZSoft::Math::PI / 4);
	...
	op = T::rotateOnZ(LZSoft::Math::PI / 3);
...
{
	T translator = T::translate(Vector3D(4, 8));
